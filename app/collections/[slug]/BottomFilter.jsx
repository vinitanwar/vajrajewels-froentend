      ...
      {showFilterDropdown && (
        ...
        >
          ...
          <div className="flex justify-between gap-2 mt-4">
            <button className="w-1/2 py-2 text-white bg-black font-medium rounded">
              Clear All
            </button>
            <button className="w-1/2 py-2 bg-gradient-to-r bg-black text-white font-medium rounded">
              APPLY FILTERS
            </button>
          </div>
        </div>
